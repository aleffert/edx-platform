...
class CourseEventBadgesConfiguration(ConfigurationModel):
    ...
    course_groups = models.TextField(
        ...
        help_text=_(
            ...
            u"award, a comma, and a comma separated list of course keys that the user will need to complete to get "
            u"this badge. For example: slug_for_compsci_courses_group_badge,course-v1:CompSci+Course+First,course-v1:"
